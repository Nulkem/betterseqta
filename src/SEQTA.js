...
function loading() {
  ...
  loadinghtml = stringToHTML(
    ...
    <div style="position: absolute;bottom: 0;right: 0;padding: 10px;color: #4f4f4f;text-anchor: middle;font-size: 20px;">v1.23</div></div>`
  );
...
function AddBetterSEQTAElements() {
  ...
  if (code != null) {
    if (!code.innerHTML.includes("BetterSEQTA")) {
      CreateBackground();
      code.innerHTML = "BetterSEQTA v1.23";
